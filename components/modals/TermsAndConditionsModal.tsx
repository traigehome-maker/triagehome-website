              ...
              <div className="space-y-0 text-gray-700 leading-none text-sm md:text-base">
                <div className="bg-blue-50/50 p-4 rounded-xl border border-blue-100">
                  ...
                  <p className="mt-2 text-sm">
                    ...
                    access to and use of the TriageHome website
                    (triage-home.com) and all related services (collectively,
                    the &lsquo;Platform&rsquo;). By accessing or using the
                    Platform, you agree to be bound by these Terms. If you do
                ...
                <div className="space-y-6">
                  <section>
                    ...
                    <p className="mt-2">
                      ...
                      facilitate connections and access between users, patients
                      and independent clinical providers.
                    </p>
                  </section>
                  ...
                  <section>
                    ...
                    <p className="mt-2 italic">
                      TriageHome is not responsible for any loss or damage
                  ...
                  <section>
                    ...
                    <ul className="list-disc ml-5 space-y-2">
                      <li>
                        TriageHome is not a hospital, clinic, or medical
                        provider.
                      </li>
                      <li>
                      ...
                      <li>
                        TriageHome does not diagnose, treat, or prescribe
                        medical conditions.
                      </li>
                      <li>
                        Users acknowledge that medical outcomes depend on
                        multiple factors and that TriageHome does not guarantee
                        treatment results.
                      </li>
                      <li>
                        In case of a medical emergency, users should contact
                  ...
                  <section>
                    ...
                    <ul className="list-disc ml-5 space-y-1">
                      ...
                      <li>
                        Refunds, if any, are subject to our refund policy and
                  ...
                  <section>
                    ...
                    <ul className="list-disc ml-5 space-y-1">
                      <li>
                        Users may cancel appointments subject to the
                        cancellation terms displayed at booking.
                      </li>
                      <li>
                        Clinical providers may cancel appointments due to
                  ...
                  <section>
                    ...
                    <p>
                      ...
                      and medical data in compliance with the Nigeria Data
                      Protection Act (NDPA).
                    </p>
                  </section>
                  ...
                  <section>
                    ...
                    <ul className="list-disc ml-5 mt-1 space-y-0">
                      <li>
                        TriageHome shall not be liable for any indirect,
                        incidental, or consequential damages
                      </li>
                      <li>
                        We are not responsible for acts, omissions, or
                        negligence of third-party healthcare providers
                      </li>
                    </ul>
                    <p className="mt-2 italic">
                  ...
                  <section>
                    ...
                    <p>
                      ...
                      directors, officers, employees, and partners from any
                      claims, losses, or damages arising out of your use of the
                  ...
                  <section>
                    ...
                    <p>
                      All content, trademarks, logos, and materials on the
                      Platform are owned by or licensed to TriageHome and may
