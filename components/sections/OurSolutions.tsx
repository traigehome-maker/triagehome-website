          ...
          {OurServicesData.map((step, i) => (
            ...
            >
              ...
              <div className="w-full h-full px-4  pb-4">
                <p
                  className={`${step.tag === "TriageApp" ? "bg-[#A6D201]" : step.tag === "TriagePods" ? "bg-[#00B89D]" : step.tag === "TriageLiving" ? "bg-[#B846D9]" : "bg-[#B846D9]"} px-3.5 py-0.5 rounded-full text-white text-lg mt-5 mb-2 w-fit`}
                >
                  {step.tag}
                </p>
